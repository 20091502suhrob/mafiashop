...
export const IndexPage: FC = () => {
  ...
  const renderBottomNav = () => (
    <nav className="fixed bottom-4 left-3 right-3 bg-white/10 border border-white/10 backdrop-blur-2xl rounded-full px-2 py-2 flex items-center justify-center gap-2 shadow-2xl">
      <button
        onClick={() => setPage('home')}
        className={`w-[72px] flex flex-col items-center justify-center gap-1 py-2 rounded-full transition ${navButtonClass('home')}`}
      >
        <span className="text-xl">💎</span>
        <span className="text-[9px] font-black uppercase tracking-tighter whitespace-nowrap">1/4/</span>
      </button>

      <button
        onClick={() => setPage('keys')}
        className={`w-[72px] flex flex-col items-center justify-center gap-1 py-2 rounded-full transition ${navButtonClass('keys')}`}
      >
        <span className="text-xl">💼</span>
        <span className="text-[9px] font-black uppercase tracking-tighter whitespace-nowrap">Keyslar</span>
      </button>

      <button
        onClick={() => setPage('market')}
        className={`w-[72px] flex flex-col items-center justify-center gap-1 py-2 rounded-full transition ${navButtonClass('market')}`}
      >
        <span className="text-xl">🏛️</span>
        <span className="text-[9px] font-black uppercase tracking-tighter whitespace-nowrap">Market</span>
      </button>

      <button
        onClick={() => setPage('friends')}
        className={`w-[72px] flex flex-col items-center justify-center gap-1 py-2 rounded-full transition ${navButtonClass('friends')}`}
      >
        <span className="text-xl">👥</span>
        <span className="text-[9px] font-black uppercase tracking-tighter whitespace-nowrap">Do'stlar</span>
      </button>

      <button
        onClick={() => setPage('profile')}
        className={`relative w-[72px] flex flex-col items-center justify-center gap-1 py-2 rounded-full transition ${navButtonClass('profile')}`}
      >
        <span className="text-xl">👤</span>
        <span className="text-[9px] font-black uppercase tracking-tighter whitespace-nowrap">Profil</span>
